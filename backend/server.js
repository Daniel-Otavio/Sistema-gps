...
const { validarUrlWebhook } = require('./src/security/outbound-url');
...
// BANCO / MIGRAÇÕES
// ======================================================
const poolPadraoMigracoes = pool;
async function criarTabelas(pool = poolPadraoMigracoes) {
