...
import { t as createCsrfMiddleware } from "./createCsrfMiddleware-CU7Y829m.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CQ5Xfdly.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BCG1-Oiv.mjs"),
		import("./start-DGrhWW1e.mjs"),
		import("./empty-plugin-adapters-CFaEYIu2.mjs")
	]);
	return {
		routerEntry,
		startEntry,
